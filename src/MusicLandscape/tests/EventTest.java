...
public class EventTest {
	...
	public void testtoString2(){
		...
		when(myV.getName()).thenReturn("my MusicLandscape.entities.Venue");
		...
		toTest.setArtist(a);
		String out="cool artist @ my MusicLandscape.entities.Venue on 09.03.2015\nmy fancy description\n(250 attending (500))";
	...
	public void EventEvent(){
		...
		assertNotSame(toCheck.getVenue(), toCopy.getVenue(), "MusicLandscape.entities.Venue has to be a deep copy of the given argument\n");
		assertNotSame(toCheck.getDate(), toCopy.getDate(), "MusicLandscape.entities.Date has to be a deep copy of the given argument\n");
